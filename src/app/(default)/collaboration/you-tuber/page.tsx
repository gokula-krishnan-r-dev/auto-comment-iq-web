"use client";
import { ListAChannle } from "@/components/shared/Competitors/add-channel";
...
const SearchChannelList = dynamic(
...
const page = () => {
  ...
  const fetchChannelLogo = async (username: any) => {
    ...
    try {
      ...
      toast.error("Error fetching channel logo: " + error.message);
    }
  };
                    ...
                    <PopoverTrigger className="flex items-center gap-2">
                      <div className="flex-1 w-full">
                        ...
                        <input
                          ...
                          className="py-2.5 px-4 block w-full outline-none border-transparent rounded-full focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-transparent dark:text-gray-400 dark:focus:ring-gray-600"
                          placeholder="Search article"
                        />
                      </div>
                      <div className="flex-[0_0_auto]">
                        <div
                          onClick={() => researchResults()}
                          className="size-[46px] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        >
                          <svg
                    ...
                    <PopoverContent className="w-[500px] rounded-3xl mr-32">
                      <ListAChannle
                        ...
                        handleAddChannel={() =>
                          ...
                          router.push(
                            `/collaboration/you-tuber/${searchResults.list?.[0][2]}`
                          )
                        }
                        button={"Send"}
                      />
